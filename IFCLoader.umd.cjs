(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('web-ifc'), require('three'), require('three/examples/jsm/utils/BufferGeometryUtils.js')) :
    typeof define === 'function' && define.amd ? define(['exports', 'web-ifc', 'three', 'three/examples/jsm/utils/BufferGeometryUtils.js'], factory) :
...
})(this, (function (exports, WebIFC, three, BufferGeometryUtils_js) { 'use strict';
    ...
    var WebIFC__namespace = /*#__PURE__*/_interopNamespaceDefault(WebIFC);
    ...
    class IFCParser {
        ...
        async loadAllGeometry(modelID) {
            ...
            Object.keys(this.geometriesByMaterials).forEach((key) => {
                ...
                const merged = BufferGeometryUtils_js.mergeBufferGeometries(geometriesByMaterial);
                materials.push(this.geometriesByMaterials[key].material);
                geometries.push(merged);
            });
            const combinedGeometry = BufferGeometryUtils_js.mergeBufferGeometries(geometries, true);
